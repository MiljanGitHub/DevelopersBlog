 ...
 *         &lt;element name="request" type="{http://Horizon.ExternalServices.AFS}AFSGetVirtualBankAccountRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetVirtualBankAccount")
public class GetVirtualBankAccount {
    ...
    protected JAXBElement<AFSGetVirtualBankAccountRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AFSGetVirtualBankAccountRequest }{@code >}
     *     
     */
    public JAXBElement<AFSGetVirtualBankAccountRequest> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<AFSGetVirtualBankAccountRequest> value) {
        this.request = value;
    }
