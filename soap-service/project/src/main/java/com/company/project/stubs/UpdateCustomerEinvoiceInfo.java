 ...
 *         &lt;element name="request" type="{http://Horizon.ExternalServices.AFS}AFSUpdateCustomerEinvoiceInfoRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "UpdateCustomerEinvoiceInfo")
public class UpdateCustomerEinvoiceInfo {
    ...
    protected JAXBElement<AFSUpdateCustomerEinvoiceInfoRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AFSUpdateCustomerEinvoiceInfoRequest }{@code >}
     *     
     */
    public JAXBElement<AFSUpdateCustomerEinvoiceInfoRequest> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<AFSUpdateCustomerEinvoiceInfoRequest> value) {
        this.request = value;
    }
