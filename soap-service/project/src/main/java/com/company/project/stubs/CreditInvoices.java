 ...
 *         &lt;element name="invoicesToCredit" type="{http://Horizon.ExternalServices.AFS}ArrayOfAFSInvoiceCreditInfo" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CreditInvoices")
public class CreditInvoices {
    ...
    @XmlElementRef(name = "invoicesToCredit", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfAFSInvoiceCreditInfo> invoicesToCredit;
    ...
    /**
     * Gets the value of the invoicesToCredit property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfAFSInvoiceCreditInfo }{@code >}
     *     
     */
    public JAXBElement<ArrayOfAFSInvoiceCreditInfo> getInvoicesToCredit() {
        return invoicesToCredit;
    }

    /**
     * Sets the value of the invoicesToCredit property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfAFSInvoiceCreditInfo }{@code >}
     *     
     */
    public void setInvoicesToCredit(JAXBElement<ArrayOfAFSInvoiceCreditInfo> value) {
        this.invoicesToCredit = value;
    }
