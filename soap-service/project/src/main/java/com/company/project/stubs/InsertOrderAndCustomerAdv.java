 ...
 *         &lt;element name="orderOptions" type="{http://Horizon.ExternalServices.AFS}AFSOrderOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "InsertOrderAndCustomerAdv")
public class InsertOrderAndCustomerAdv {
    ...
    @XmlElementRef(name = "orderOptions", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<AFSOrderOptions> orderOptions;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AFSOrderOptions }{@code >}
     *     
     */
    public JAXBElement<AFSOrderOptions> getOrderOptions() {
        return orderOptions;
    }
     ...
     *     
     */
    public void setOrderOptions(JAXBElement<AFSOrderOptions> value) {
