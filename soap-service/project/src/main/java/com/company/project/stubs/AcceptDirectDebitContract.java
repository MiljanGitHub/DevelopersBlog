 ...
 *         &lt;element name="request" type="{http://Horizon.ExternalServices.AFS}AFSAcceptDirectDebitContractRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "AcceptDirectDebitContract")
public class AcceptDirectDebitContract {
    ...
    protected JAXBElement<AFSAcceptDirectDebitContractRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AFSAcceptDirectDebitContractRequest }{@code >}
     *     
     */
    public JAXBElement<AFSAcceptDirectDebitContractRequest> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<AFSAcceptDirectDebitContractRequest> value) {
        this.request = value;
    }
