 ...
 *         &lt;element name="ledgerOptions" type="{http://Horizon.ExternalServices.AFS}AFSLedgerOptions" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetLedgerAdv")
public class GetLedgerAdv {
    ...
    @XmlElementRef(name = "ledgerOptions", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<AFSLedgerOptions> ledgerOptions;
    ...
    /**
     * Gets the value of the ledgerOptions property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AFSLedgerOptions }{@code >}
     *     
     */
    public JAXBElement<AFSLedgerOptions> getLedgerOptions() {
        return ledgerOptions;
    }

    /**
     * Sets the value of the ledgerOptions property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AFSLedgerOptions }{@code >}
     *     
     */
    public void setLedgerOptions(JAXBElement<AFSLedgerOptions> value) {
        this.ledgerOptions = value;
    }
