 ...
 *         &lt;element name="request" type="{http://Horizon.ExternalServices.AFS}AFSUpdateMerchantInfoRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "UpdateMerchantInfo")
public class UpdateMerchantInfo {
    ...
    protected JAXBElement<AFSUpdateMerchantInfoRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AFSUpdateMerchantInfoRequest }{@code >}
     *     
     */
    public JAXBElement<AFSUpdateMerchantInfoRequest> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<AFSUpdateMerchantInfoRequest> value) {
        this.request = value;
    }
