 ...
 *         &lt;element name="request" type="{http://Horizon.ExternalServices.AFS}AFSGetClientLimitRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetClientLimit")
public class GetClientLimit {
    ...
    protected JAXBElement<AFSGetClientLimitRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AFSGetClientLimitRequest }{@code >}
     *     
     */
    public JAXBElement<AFSGetClientLimitRequest> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<AFSGetClientLimitRequest> value) {
        this.request = value;
    }
